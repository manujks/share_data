...
plot(10^-9*A.Freq_Hz_,A.S11_DB_, 'LineWidth', 1.5)
...
% plot(10^-9*A.Freq_Hz_,A.S11_DB_, 'LineWidth', 1.5)
   %     axis([F(end,1)/1e12, F(1,1)/1e12, -100, 0])
        ...
        ylabel('S11 [dB]')
        title('S11 at -40 dBm vs freq')
 
 hold on;
 
 %legend('RF power=-20 dBm','RF power=-25 dBm','RF power=-30 dBm','RF power=-35 dBm','RF power=-40 dBm','RF power=-45 dBm','RF power=-50 dBm')